classdef Forward_First_Order_Test < matlab.unittest.TestCase
    ...
    methods(Test, TestTags={'Small'})
        ...
        function test_it_approximates_the_first_derivative_of_a_linear_function_by_machine_precission(t, N)
            ...
            t.assertEqual(b(2 : end - 1), df(x(2 : end - 1)), 'AbsTol', eps(10 * N), ...
                'The first order forward difference method should approximate the derivative of a linear function with machine precision.' ...
            );
        end
